...
def construction_zone_report():
    ...
    if (prob_x_nca_prob_nca > prob_x_ca_prob_ca):
        print(" RESULT: Given the crash senerio X = [Weather Condition: Clear, Road Condition: Dry, Construction Zone: True] we predict there will be No Contributing Action from the driver.")
    else:
        print(" RESULT: Given the crash senerio X = [Weather Condition: Clear, Road Condition: Dry, Construction Zone: True] we predict there will be a Contributing Action from the driver.")
